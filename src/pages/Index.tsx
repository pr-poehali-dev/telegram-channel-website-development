...
const FEATURES = [
  {
    ...
    desc: "Карточки товаров для WB и Ozon, которые привлекают внимание и увеличивают конверсию.",
    color: "#00cfff",
  },
  {
    icon: "BarChart2",
    title: "Инфографика и данные",
    desc: "Превращаю сложные данные в понятные и красивые визуальные истории.",
    color: "#a855f7",
  },
  {
    icon: "Sparkles",
    title: "ИИ в дизайне",
    desc: "Использую Midjourney, Deepseek, Grok для генерации фонов, иконок и идей — показываю как.",
    color: "#ec4899",
  },
  {
    icon: "Printer",
    title: "Полиграфия и наружка",
    desc: "Баннеры, листовки, вывески — делюсь кейсами и нюансами подготовки макетов к печати.",
    color: "#f59e0b",
  },
  {
    icon: "Layers",
    title: "Соцсети и контент",
    desc: "Шаблоны и визуалы для Instagram, VK, Telegram — быстро, стильно, в едином стиле.",
    color: "#10b981",
  },
  {
    icon: "Lightbulb",
    title: "Разборы и кейсы",
    desc: "Показываю процесс работы изнутри: от брифа до финального макета с реальными примерами.",
    color: "#00cfff",
  },
];
...
const FAQS = [
  {
    q: "Для кого этот канал?",
    a: "Для дизайнеров, фрилансеров, владельцев магазинов на WB и Ozon, а также всех, кто хочет делать красивый и продающий визуал.",
  },
  {
    q: "Вы делаете визуалы на заказ?",
    a: "Да! Создаю карточки для маркетплейсов, инфографику, баннеры и материалы для соцсетей. Пишите в личку для обсуждения проекта.",
  },
  {
    q: "Какие ИИ-инструменты вы используете?",
    a: "Работаю с Midjourney, Nano Banana, Deepseek и Grok — для генерации фонов, иконок и поиска идей. Делюсь лайфхаками прямо в канале.",
  },
  {
    q: "Можно ли заказать инфографику для Ozon или WB?",
    a: "Конечно! Разрабатываю инфографику под требования маркетплейсов: правильные размеры, акценты на УТП и продающий визуал.",
  },
  {
    q: "Канал платный или бесплатный?",
    a: "Канал полностью бесплатный. Подписывайтесь и читайте без ограничений.",
  },
];

const STATS = [
  { value: "1K+", label: "подписчиков" },
  { value: "10", label: "постов в день" },
